...
export default function HeroBanner() {
  ...
  return (
    <>
      <section className="relative min-h-[800px] w-full overflow-hidden bg-gradient-to-b from-[#2637e6] via-[#ba406e] to-white">
        {/* Background Gradient Effects */}
        <div className="pointer-events-none absolute -left-[10%] top-[-20%] h-[650px] w-[700px] rounded-full bg-[#1538ff] blur-[100px]" />

        <div className="pointer-events-none absolute left-1/2 top-[-35%] h-[700px] w-[700px] -translate-x-1/2 rounded-full bg-[#8f257e]/80 blur-[130px]" />

        <div className="pointer-events-none absolute -right-[15%] top-[-10%] h-[650px] w-[700px] rounded-full bg-[#ff512d]/90 blur-[110px]" />

        <div className="pointer-events-none absolute -right-[10%] top-[25%] h-[500px] w-[600px] rounded-full bg-[#ffc1ac]/80 blur-[120px]" />

        {/* Bottom Left White Effect */}
        <div className="pointer-events-none absolute -bottom-[20%] -left-[10%] h-[550px] w-[700px] rounded-full bg-white/95 blur-[100px]" />

        {/* Bottom Right White Effect */}
        <div className="pointer-events-none absolute -bottom-[15%] -right-[10%] h-[550px] w-[700px] rounded-full bg-white/95 blur-[100px]" />

        {/* Main Container */}
        <div className="relative z-10 mx-auto flex min-h-[800px] w-full flex-col justify-between px-5 pb-7 pt-20 md:px-8 md:pt-24 lg:px-12">
          {/* Hero Content */}
          <div className="mx-auto w-full max-w-[1150px] text-center">
            {/* Badge */}
            <div className="mx-auto mb-8 flex w-fit max-w-full items-center overflow-hidden rounded-full bg-white/20 text-[12px] font-semibold text-white backdrop-blur-md sm:text-sm md:text-base">
              ...
              <span className="whitespace-nowrap px-3 py-2.5 md:px-4">
            ...
            {/* Description */}
            <p className="mx-auto mt-7 max-w-[950px] text-[15px] font-medium leading-[1.55] text-white/95 md:mt-8 md:text-[17px] lg:text-[18px]">
            ...
            {/* Buttons */}
            <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row md:mt-12">
              <Link
                href="/contact"
