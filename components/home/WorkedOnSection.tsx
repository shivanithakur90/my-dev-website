          ...
          {projects.map((project) => (
            <SwiperSlide key={project.title} className="h-auto pb-10">
              ...
              <div className="p-5">
                ...
                <div className="group/link mt-2 flex w-fit items-center gap-1.5 text-sm font-medium text-[#3434ef] transition-colors duration-300 group-hover:text-[#e64500] hover:text-[#e64500]">
                  <span className="max-w-[190px] truncate transition-colors duration-300 group-hover:underline group-hover:underline-offset-4 group-hover/link:underline group-hover/link:underline-offset-4">
                    {project.url.replace("https://", "")}
                  </span>
                  <span className="transition-transform duration-300 group-hover:translate-x-1 group-hover/link:translate-x-1">
                    <ExternalIcon />
                  </span>
                </div>
